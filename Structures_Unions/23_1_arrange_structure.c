/* Write a program in C to take name, age and address of n number of students from the user and
 arrange them in ascending order on the basis of name by using the concept of structure.*/
#include <stdio.h>
#include <string.h>
...
int main() 
{
    ...
    printf("The details of the students arranged in ascending order on the basis of name are:\n");
    for (int i = 0; i < n; i++)
    {
